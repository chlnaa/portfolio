      ...
      <div className='relative mx-auto grid max-w-7xl gap-16 lg:grid-cols-2 lg:gap-20'>
        ...
        <div className='flex flex-col justify-center'>
          ...
          >
            ...
            <br />
            <span className='text-foreground'>Predictable State</span>
            <br />
            <span className='text-gradient'>and Scalable UI Systems</span>
          </motion.h1>
          ...
          >
            Focused on the structural design of data flow and user interaction
            patterns to build maintainable, high-performance systems.
          </motion.p>
        </div>
